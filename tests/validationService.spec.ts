...
describe('ValidationService', () => {
  ...
  describe('getValidatedModelPropertyEventName', () => {
    it('returns data-validation-validated-model-property-[id]-[name]', () => {
      var eventName = service.getValidatedModelPropertyEventName('foo', 'bar');
      expect(eventName).toBeDefined();
      expect(typeof eventName).toBe('string');
